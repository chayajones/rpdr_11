...
for (t_current in (L+1):(next_t - 1)) {
  ...
  for (n in 1:nrow(newdata)) {
    ...
    eta_s[,n] <- s$beta_asian * newdata$asian[n] + s$beta_latino * newdata$latino[n] + s$beta_drag_house_ind * newdata$drag_house_ind[n] + s$beta_past_top * newdata$z.past_top[n] + s$beta_past_bottom * newdata$z.past_bottom[n] + alpha_contestant_s
  }
