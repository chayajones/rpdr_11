...
wrangled <- all_rankings_next %>%
  ...
  select(season_number, episode_number, t, contestant_id, contestant_name, # identifiers
         ethnicity, asian, black, latino, white, z.age, z.past_wins, z.past_lipsync, z.past_top, z.past_safe, z.past_bottom, plus_size, drag_house_ind, drag_fam_competed, puerto_rican, new_york_city, # x variables
