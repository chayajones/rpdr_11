...
all_episodes_next <- add_row(all_episodes, season_number = 11, episode_number = 6,
...
all_rankings_next <- add_row(all_rankings, season_number = 11, episode_number = 6, 
...
for (t_current in (L+1):(next_t - 1)) {
  ...
  for (n in 1:nrow(newdata)) {
    ...
    # eta_s[,n] <- s$beta_puerto_rican * newdata$puerto_rican + s$beta_drag_house_ind * newdata$drag_house_ind + s$beta_past_lipsync * newdata$z.past_lipsync[n] + s$beta_past_low * newdata$z.past_low[n] + s$beta_past_safe * newdata$z.past_safe[n] + s$beta_past_high * newdata$z.past_high[n] + s$beta_past_wins * newdata$z.past_wins[n] + alpha_contestant_s

    # eta_s[,n] <- s$beta_puerto_rican * newdata$puerto_rican + s$beta_drag_house_ind * newdata$drag_house_ind + s$beta_past_lipsync * newdata$z.past_lipsync[n] + s$beta_past_low * newdata$z.past_low[n] + s$beta_past_high * newdata$z.past_high[n] + s$beta_past_wins * newdata$z.past_wins[n] + alpha_contestant_s

    # eta_s[,n] <- s$beta_puerto_rican * newdata$puerto_rican + s$beta_drag_house_ind * newdata$drag_house_ind + s$beta_past_lipsync * newdata$z.past_lipsync[n] + s$beta_past_low * newdata$z.past_low[n] + s$beta_past_high_safe * newdata$z.past_high_safe[n] + s$beta_past_wins * newdata$z.past_wins[n] + alpha_contestant_s
